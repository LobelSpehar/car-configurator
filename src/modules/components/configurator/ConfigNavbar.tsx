...
export function ConfigNavbar(props: ConfigNavbarProps) {
  return (
    <div className='pt-5 z-10 relative pl-10 flex w-full h-20 bg-[#fcfcfd] border border-[#C7C7D1] border-solid border-b-1'>
      {props.stepCount === 0 ? (
        <Link to='/'>
          <svg
      ...
      <p
        className={
          props.stepCount === 0
            ? 'ml-auto font-bold mt-2 mr-2 md:mr-14 inter  text-[#9D9DAF]'
            : 'ml-auto mt-2 mr-2 md:mr-14 inter  text-[#9D9DAF]'
        }
      >
      ...
      <p
        className={
          props.stepCount === 1
            ? 'font-bold mt-2 mr-2 md:mr-14 inter  text-[#9D9DAF]'
            : 'mt-2 mr-2 md:mr-14 inter  text-[#9D9DAF]'
        }
      >
